...
?>
<?php 
if(!empty($waste_anual_pie_chart)){
	$generalwaste = $waste_anual_pie_chart['generalwaste'];
	$paperwaste = $waste_anual_pie_chart['paperwaste'];
	$foodwaste = $waste_anual_pie_chart['foodwaste'];
	$cardboardwaste = $waste_anual_pie_chart['cardboardwaste'];
	$plasticwaste = $waste_anual_pie_chart['plasticwaste'];
	$glasswaste = $waste_anual_pie_chart['glasswaste'];
...
if(!empty($waste_anual_Landfill_pie_chart))
{
	$recycledwaste = $waste_anual_Landfill_pie_chart['recycledwaste'];
	$landfill = $waste_anual_Landfill_pie_chart['landfill'];
                ...
                <tr>
                    <td width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="50%"><img height="350" src="<?php echo $pieAnnualChartNewImg_hidden; ?>" /></td>
                                <td width="50%"><img height="350" src="<?php echo $pieAnnualLandfillImg_hidden; ?>" /></td>
                            </tr>
                            <tr>
                                <td valign="top">
                                    <table border="1" width="100%" cellpadding="2" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th style="background-color:#d8e1f2;" align="center"><strong><?php echo lang("waste_annual_pie_report").' - '.$filters["report_year_pre"]; ?></strong></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                ...
                                <td valign="top">
                                    <table border="1" width="100%" cellpadding="2" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th style="background-color:#d8e1f2;" align="center"><strong><?php echo lang("waste_annual_landfill_pie_report").' - '.$filters["report_year_pre"]; ?></strong></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="35%"><strong><?php echo number_format(round($total));?></strong></td>
                                                                <td width="20%"><strong><?php echo $share; ?>%</strong></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
