...
<script type="text/javascript">
    ...
    function drawChart() {
		...
		?>
            ...
            var options = {
                isStacked: true,
                title: '<?php echo lang('carbon-footprint-title'); ?>',
                titleTextStyle: {
                  fontName: 'Arial',
                  fontSize: 28
                },
                ...
                vAxes: {
                    0: { title:'<?php echo lang("utility-kgco2-chart-yaxis-0-title"); ?>',titleTextStyle: {fontName: 'Arial',}},
...
<div id="ajax_table" class="report-detail">
    <article class="card">
        <div class="article-header"><?php echo 'Carbon FootPrint' /*lang('reports');*/ ?></div>
        <div>
        	<form name="report_excel_form" id="report_excel_form" method="post">
	            ...
	            <div class="form-btn-outer" style="float: left;">
	            	<input type="hidden" name="view_type" value="excel" />
	            	<button type="submit" class="btn btn-secondary btn-submit" id="mysubmit" name="submit">Generate Excel</button>
	            </div>
	        </form>
        </div>
        <div class="card-wrap">
