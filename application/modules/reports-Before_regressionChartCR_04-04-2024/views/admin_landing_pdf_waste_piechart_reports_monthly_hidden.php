...
if(!empty($waste_monthly_pie_chart_results)){
	...
	$generalwasteShare = ($totalwaste != 0) ? round(($generalwaste*100)/$totalwaste,1) : 0;
	$paperwasteShare = ($totalwaste != 0) ? round(($paperwaste*100)/$totalwaste,1) : 0;
	$foodwasteShare = ($totalwaste != 0) ? round(($foodwaste*100)/$totalwaste,1) : 0;
	$cardboardwasteShare = ($totalwaste != 0) ? round(($cardboardwaste*100)/$totalwaste,1) : 0;
	$plasticwasteShare = ($totalwaste != 0) ? round(($plasticwaste*100)/$totalwaste,1) : 0;
	$glasswasteShare = ($totalwaste != 0) ? round(($glasswaste*100)/$totalwaste,1) : 0;
	...
	$recycledwasteShare = ($total != 0) ? round(($recycledwaste*100)/$total,1) : 0;
	$landfillShare = ($total != 0) ? round(($landfill*100)/$total,1) : 0;
