 ...
 * @author AMPT
 */
class User_login_log_admin extends Base_Admin_Controller
{
    /*
     * Create an instance
     */
    ...
    public function index($language_code = '')
    {
        ...
        $this->user_login_log_model->record_per_page = $this->record_per_page;
        $this->user_login_log_model->offset          = $offset;
        ...
        $logs                  = $this->user_login_log_model->getLog($filters);
        $total_records         = $this->user_login_log_model->getLogCount($filters);
        $data['csrf_token']    = $this->security->get_csrf_token_name();
        $data['csrf_hash']     = $this->security->get_csrf_hash();
        $data['logs']          = $logs;
        $data['roles']         = $this->user_login_log_model->getRoles();
        ...
        // Breadcrumb settings
        $this->breadcrumb->add('Login Log', base_url() . $this->section_name . '/user_login_log');
        //Create page-title
