...
<div id="ajax_table">
    <article class="card">
        <div class="article-header"><?php echo lang('my-contribution'); ?></div>
        <div class="card-wrap">
                                      		...
                                      		<div class="forum-links clearfix">
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                    ...
                                                    <a href="<?php echo site_url(); ?>forum/mycontribution" class="activelink"><?php echo lang('my-contribution'); ?></a>
                                                    <?php
                                                }
                                                //else {
                                                ?>
