<div id="ajax_table" class="utilities-detail-wrap">
    <article class="card">
    <div class="article-header"><?php echo lang('forum'); ?></div>
    <div class="card-wrap">
                                    ...
                                    <div class="col-sm-9 listing-right">
                                        ...
                                        <div class="meessage-block">                                            
                                            <div class="forum-links clearfix">
                                                <a class="activelink" href="<?php echo site_url(); ?>forum/forum_listing"><?php echo lang('forum'); ?></a>
                                                <?php
                                                if (isset($logged_in)) {
                                                    ?>
                                            ...
                                            <div class="compose-form-div clearfix">
                                                <div class="forum-title clearfix">
                                                    ...
                                                    <p class="post-created-by"><?php echo 'Created By'; ?> </p>
                                                ...
                                                if (!empty($forums)) {
                                                    ...
                                                    foreach ($forums as $forum) {
                                                        ...
                                                        <?php
                                                        if ($category != $forum['c']['title']) {
                                                            ?>
                                                                <div class="post-list clearfix">
                                                                    <p class="post-title">
                                                                        <a href="#">
                                                                            <?php echo $forum['c']['title']; ?>
                                                                            <?php
                                                                            $category = $forum['c']['title'];
                                                                            ?>
                                                                        </a></p>
                                                                </div>
                                                                            <?php }
                                                            ...
                                                            <div class="post-list sub-post clearfix">
                                                                ...
                                                                <p class="post-created-by"><?php echo $forum['U']['firstname'].' '.$forum['U']['lastname']; ?> </p>
    ...
    echo '<span class="norecfound norecfound1">' . lang('no_records_found') . '</span>';
}
?>
                                            </div>
                                        </div>
