...
$popupInfoArray = [
    'f_b' => 'Number of food and beverage venues or function spaces operated by '.SITE_APPLICATION_NAME.'',
    'f_b_outsourced' => 'Number of food and beverage venues or function spaces operated by a third-party (not '.SITE_APPLICATION_NAME.')',
    'rental_program_suites' => 'Number of rental program residence rooms/suites (includes rooms managed by '.SITE_APPLICATION_NAME.' AND Condo Hotel units)',
    'rental_private_suites' => 'Number of Private Residence Rooms/Suites (includes Residence Club units, others NOT managed by '.SITE_APPLICATION_NAME.')',
...
<article class="card">
	...
	<ul class="form-outer-block">
		...
		<div class="row">
		    ...
		    <div class="form-col-3">
				<div class="form-dropdown">
					...
					?><span class="validation_error country-error"><?php echo form_error('country_id'); ?></span>
				</div>
	    ...
	    <br/>
	    <li>
		<label class="main-label"><?php echo lang('comments'); ?></label>
		<div class="row">
			...
			$comments = array(
			    'name' => 'comments',
			    'id' => 'comments',
			    'value' => set_value('comments', ((isset($comments)) ? htmlspecialchars_decode($comments) : '')),
			    'class' => 'input-control',
			    'style' => 'height: 150px;'
			);
			?>
			<?php echo form_textarea($comments); ?><span class="validation_error"><?php echo form_error('comments'); ?></span>
	...
	<ul class="form-group-label form-outer-block">
		<li>
		    <label for="outdoor_pools" class="main-label"><?php echo lang('outdoor-pools'); ?> <span class="asterisk">*</span></label>
		    <div class="row">
			<div class="form-col-3">
			    <?php
			    $outdoor_pools = array(
