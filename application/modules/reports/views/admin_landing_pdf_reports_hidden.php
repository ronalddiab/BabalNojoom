...
if (!empty($utility_cost_chart_pre)) {
    ...
    foreach ($resultkeys as $year => $value) {
        ...
        foreach ($value as $key1 => $month) {
            ...
            $pre_data_electricity = (!empty($utility_cost_chart_pre[$month][$pre_year]['electricity'])) ? $utility_cost_chart_pre[$month][$pre_year]['electricity'] : 0;

            $pre_data_fuel = (!empty($utility_cost_chart_pre[$month][$pre_year]['fuel'])) ? $utility_cost_chart_pre[$month][$pre_year]['fuel'] : 0;

            $pre_data_fuel_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['fuel_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['fuel_consumption'] : 0;

            $pre_data_lpg = (!empty($utility_cost_chart_pre[$month][$pre_year]['lpg'])) ? $utility_cost_chart_pre[$month][$pre_year]['lpg'] : 0;

            $pre_data_lpg_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['lpg_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['lpg_consumption'] : 0;

            $pre_data_natural_gas = (!empty($utility_cost_chart_pre[$month][$pre_year]['natural_gas'])) ? $utility_cost_chart_pre[$month][$pre_year]['natural_gas'] : 0;

            $pre_data_natural_gas_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['natural_gas_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['natural_gas_consumption'] : 0;

            $pre_data_heating_district = (!empty($utility_cost_chart_pre[$month][$pre_year]['heating_district'])) ? $utility_cost_chart_pre[$month][$pre_year]['heating_district'] : 0;

            $pre_data_heating_district_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['heating_district_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['heating_district_consumption'] : 0;

            $pre_data_cooling_district = (!empty($utility_cost_chart_pre[$month][$pre_year]['cooling_district'])) ? $utility_cost_chart_pre[$month][$pre_year]['cooling_district'] : 0;

            $pre_data_cooling_district_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['cooling_district_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['cooling_district_consumption'] : 0;

            $pre_data_water = (!empty($utility_cost_chart_pre[$month][$pre_year]['water'])) ? $utility_cost_chart_pre[$month][$pre_year]['water'] : 0;

            $pre_data_water_consumption = (!empty($utility_cost_chart_pre[$month][$pre_year]['water_consumption'])) ? $utility_cost_chart_pre[$month][$pre_year]['water_consumption'] : 0;

            $pre_data_cdd = (!empty($utility_cost_chart_pre[$month][$pre_year]['cdd'])) ? $utility_cost_chart_pre[$month][$pre_year]['cdd'] : 0;
            ...
            $pre_data_guest_night = (!empty($utility_cost_chart_pre[$month][$pre_year]['guest_night'])) ? $utility_cost_chart_pre[$month][$pre_year]['guest_night'] : 0;
            $pre_data_guest_night_budget = (!empty($utility_cost_chart_pre[$month][$pre_year]['total_guests_budget'])) ? $utility_cost_chart_pre[$month][$pre_year]['total_guests_budget'] : 0;

            $pre_data_electricity_tariff = (!empty($utility_cost_chart_pre[$month][$pre_year]['electricity_tariff'])) ? $utility_cost_chart_pre[$month][$pre_year]['electricity_tariff'] : 0;

            $pre_data_electricity_kwh = (!empty($utility_cost_chart_pre[$month][$pre_year]['total_electricity_kwh'])) ? $utility_cost_chart_pre[$month][$pre_year]['total_electricity_kwh'] : 0;
            ...
            $data_fuel_consumption = (!empty($utility_cost_chart_pre[$month][$year]['fuel_consumption'])) ? $utility_cost_chart_pre[$month][$year]['fuel_consumption'] : 0;

            $data_lpg = (!empty($utility_cost_chart_pre[$month][$year]['lpg'])) ? $utility_cost_chart_pre[$month][$year]['lpg'] : 0;

            $data_lpg_consumption = (!empty($utility_cost_chart_pre[$month][$year]['lpg_consumption'])) ? $utility_cost_chart_pre[$month][$year]['lpg_consumption'] : 0;

            $data_natural_gas = (!empty($utility_cost_chart_pre[$month][$year]['natural_gas'])) ? $utility_cost_chart_pre[$month][$year]['natural_gas'] : 0;

            $data_natural_gas_consumption = (!empty($utility_cost_chart_pre[$month][$year]['natural_gas_consumption'])) ? $utility_cost_chart_pre[$month][$year]['natural_gas_consumption'] : 0;
            ...
            $data_heating_district_consumption = (!empty($utility_cost_chart_pre[$month][$year]['heating_district_consumption'])) ? $utility_cost_chart_pre[$month][$year]['heating_district_consumption'] : 0;
            ...
            $data_cooling_district_consumption = (!empty($utility_cost_chart_pre[$month][$year]['cooling_district_consumption'])) ? $utility_cost_chart_pre[$month][$year]['cooling_district_consumption'] : 0;

            $data_water = (!empty($utility_cost_chart_pre[$month][$year]['water'])) ? $utility_cost_chart_pre[$month][$year]['water'] : 0;

            $data_water_consumption = (!empty($utility_cost_chart_pre[$month][$year]['water_consumption'])) ? $utility_cost_chart_pre[$month][$year]['water_consumption'] : 0;
            ...
            $data_guest_night_budget = (!empty($utility_cost_chart_pre[$month][$year]['total_guests_budget'])) ? $utility_cost_chart_pre[$month][$year]['total_guests_budget'] : 0;
            ...
            $total_sum_pre_data_guest_night_budget += $pre_data_guest_night_budget;
            ...
            $total_sum_data_guest_night_budget += $data_guest_night_budget;
    ...
    if ($total_sum_pre_data_electricity_kwh > 0) {
        ...
        $total_sum_pre_data_electricity_tariff = ($total_sum_pre_data_electricity_kwh != 0) ? ($total_sum_pre_data_electricity / $total_sum_pre_data_electricity_kwh) : 0;
    ...
    if ($total_sum_data_electricity_kwh > 0) {
        ...
        $total_sum_data_electricity_tariff = ($total_sum_data_electricity != 0) ? ($total_sum_data_electricity / $total_sum_data_electricity_kwh) : 0;
    ...
    if (!empty($total_sum_data_fuel)) {
        ...
        $total_sum_data_fuel_tariff = ($total_sum_data_fuel_consumption != 0) ? round($total_sum_data_fuel / $total_sum_data_fuel_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_fuel)) {
        ...
        $total_sum_pre_data_fuel_tariff = ($total_sum_pre_data_fuel_consumption != 0) ? round($total_sum_pre_data_fuel / $total_sum_pre_data_fuel_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_data_lpg)) {
        ...
        $total_sum_data_lpg_tariff = ($total_sum_data_lpg_consumption != 0) ? round($total_sum_data_lpg / $total_sum_data_lpg_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_lpg)) {
        ...
        $total_sum_pre_data_lpg_tariff = ($total_sum_pre_data_lpg_consumption != 0) ? round($total_sum_pre_data_lpg / $total_sum_pre_data_lpg_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_data_natural_gas)) {
        ...
        $total_sum_data_natural_gas_tariff = ($total_sum_data_natural_gas_consumption != 0) ? round($total_sum_data_natural_gas / $total_sum_data_natural_gas_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_natural_gas)) {
        ...
        $total_sum_pre_data_natural_gas_tariff = ($total_sum_pre_data_natural_gas_consumption != 0) ? round($total_sum_pre_data_natural_gas / $total_sum_pre_data_natural_gas_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_data_heating_district)) {
        ...
        $total_sum_data_heating_district_tariff = ($total_sum_data_heating_district_consumption != 0) ? round($total_sum_data_heating_district / $total_sum_data_heating_district_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_heating_district)) {
        ...
        $total_sum_pre_data_heating_district_tariff = ($total_sum_pre_data_heating_district_consumption != 0) ? round($total_sum_pre_data_heating_district / $total_sum_pre_data_heating_district_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_data_cooling_district)) {
        ...
        $total_sum_data_cooling_district_tariff = ($total_sum_data_cooling_district_consumption != 0) ? round($total_sum_data_cooling_district / $total_sum_data_cooling_district_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_cooling_district)) {
        ...
        $total_sum_pre_data_cooling_district_tariff = ($total_sum_pre_data_cooling_district_consumption) ? round($total_sum_pre_data_cooling_district / $total_sum_pre_data_cooling_district_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_data_water)) {
        ...
        $total_sum_data_water_tariff = ($total_sum_data_water_consumption != 0) ? round($total_sum_data_water / $total_sum_data_water_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_water)) {
        ...
        $total_sum_pre_data_water_tariff = ($total_sum_pre_data_water_consumption != 0) ? round($total_sum_pre_data_water / $total_sum_pre_data_water_consumption, $value_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_room_night)) {
        ...
        $total_sum_pre_data_fuel_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_fuel_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_lpg_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_lpg_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_natural_gas_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_natural_gas_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_heating_district_per_room_night = ($total_sum_pre_data_room_night != 0) ?  round($total_sum_pre_data_heating_district_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_cooling_district_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_cooling_district_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_water_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_water_consumption / $total_sum_pre_data_room_night, $percentage_decimal) : 0;

        $total_sum_pre_data_electricity_per_room_night = ($total_sum_pre_data_room_night != 0) ? round($total_sum_pre_data_electricity_kwh / $total_sum_pre_data_room_night, $percentage_decimal) : 0;
    ...
    if (!empty($total_sum_data_room_night) && $total_sum_data_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_fuel_per_room_night)) {
        ...
        $fuel_per_room_night_difference_percent = ($total_sum_pre_data_fuel_per_room_night != 0) ? round($fuel_per_room_night_difference_value * 100 / $total_sum_pre_data_fuel_per_room_night, $percentage_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_lpg_per_room_night)) {
        ...
        $lpg_per_room_night_difference_percent = ($total_sum_pre_data_lpg_per_room_night != 0) ? round($lpg_per_room_night_difference_value * 100 / $total_sum_pre_data_lpg_per_room_night, $percentage_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_natural_gas_per_room_night) && $total_sum_pre_data_natural_gas_per_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_heating_district_per_room_night) && $total_sum_pre_data_heating_district_per_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_cooling_district_per_room_night) && $total_sum_pre_data_cooling_district_per_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_water_per_room_night) && $total_sum_pre_data_water_per_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_electricity_per_room_night) && $total_sum_pre_data_electricity_per_room_night != 0) {
    ...
    if (!empty($total_sum_pre_data_lpg_consumption) && $total_sum_pre_data_lpg_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_natural_gas_consumption) && $total_sum_pre_data_natural_gas_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_heating_district_consumption) && $total_sum_pre_data_heating_district_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_cooling_district_consumption) && $total_sum_pre_data_cooling_district_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_water_consumption) && $total_sum_pre_data_water_consumption != 0) {
	...
	if (!empty($total_sum_pre_data_guest_night) && $total_sum_pre_data_guest_night > 0) {
        ...
        $total_sum_data_guest_night_variation = round(((($total_sum_data_guest_night - $total_sum_pre_data_guest_night) * 100) / $total_sum_pre_data_guest_night), $percentage_decimal);
    ...
    $room_night_budget_variation = ($total_sum_data_total_room_night_budget != 0) ? round((($total_sum_data_room_night - $total_sum_data_total_room_night_budget) * 100) / $total_sum_data_total_room_night_budget, $percentage_decimal) : 0;

    $guest_night_budget_variation = ($total_sum_data_guest_night_budget != 0) ? round((($total_sum_data_guest_night - $total_sum_data_guest_night_budget) * 100) / $total_sum_data_guest_night_budget, $percentage_decimal) : 0;
    ...
    if (!empty($total_sum_pre_data_fuel_tariff) && $total_sum_pre_data_fuel_tariff != 0) {
    ...
    if (!empty($total_sum_pre_data_lpg_tariff) && $total_sum_pre_data_lpg_tariff != 0) {
    ...
    if (!empty($total_sum_pre_data_natural_gas_tariff) && $total_sum_pre_data_natural_gas_tariff != 0) {
    ...
    if (!empty($total_sum_pre_data_heating_district_tariff) && $total_sum_pre_data_heating_district_tariff != 0) {
    ...
    if (!empty($total_sum_pre_data_cooling_district_tariff) && $total_sum_pre_data_cooling_district_tariff != 0) {
    ...
    if (!empty($total_sum_pre_data_water_tariff) && $total_sum_pre_data_water_tariff != 0) {
    ...
    $total_sum_pre_data_electricity_kwh_per_roomnight = ($total_sum_pre_data_room_night > 0) ? ($total_sum_pre_data_electricity_kwh / $total_sum_pre_data_room_night) : 0;

    $total_sum_pre_data_electricity_kwh_per_m2 = ($total_sum_pre_data_electricity_kwh / $site_detail['site_builtup_area']);

    $total_sum_pre_data_water_liter_per_roomnight = ($total_sum_pre_data_room_night > 0) ?($total_sum_pre_data_water / $total_sum_pre_data_room_night) : 0;
    ...
    $total_sum_data_electricity_kwh_per_roomnight = ($total_sum_data_room_night > 0) ? ($total_sum_data_electricity_kwh / $total_sum_data_room_night) : 0;
    ...
    $total_sum_data_utility_cost_per_roomnight = ($total_sum_data_room_night != 0) ? round($total_sum_data_sum / $total_sum_data_room_night, $value_decimal) : 0;

    $total_sum_data_utility_cost_per_m2 = round($total_sum_data_sum / $site_detail['site_builtup_area'], $value_decimal);
    ...
    $data_utility_cost_per_roomnight_variation = ($total_sum_data_utility_cost_per_roomnight != 0) ? round($data_utility_cost_per_roomnight_difference * 100 / $total_sum_data_utility_cost_per_roomnight, $percentage_decimal) : 0;



    $data_utility_cost_per_m2_difference = $total_sum_data_utility_cost_per_m2 - $total_sum_pre_data_utility_cost_per_m2;

    $data_utility_cost_per_m2_variation = ($total_sum_data_utility_cost_per_m2 != 0) ? round($data_utility_cost_per_m2_difference * 100 / $total_sum_data_utility_cost_per_m2, $percentage_decimal) : 0;
...
if ($showCostBudgetVariance) {
    ...
    $electricity_tariff_budget = ($currentBudgetActualData["total_electricity_kwh_budget"] != 0) ?  round($currentBudgetActualData["total_electricity_cost_budget"] / $currentBudgetActualData["total_electricity_kwh_budget"], $value_decimal) : 0;

    $fuel_oil_tariff_budget = ($currentBudgetActualData["total_fuel_oil_budget"] != 0) ? round($currentBudgetActualData["total_fuel_oil_cost_budget"] / $currentBudgetActualData["total_fuel_oil_budget"], $value_decimal) : 0;

    $lpg_tariff_budget = ($currentBudgetActualData["total_lpg_budget"] != 0 ) ? round($currentBudgetActualData["total_lpg_cost_budget"] / $currentBudgetActualData["total_lpg_budget"], $value_decimal) : 0;

    $natural_gas_tariff_budget = ($currentBudgetActualData["total_natural_gas_budget"] != 0) ? round($currentBudgetActualData["total_natural_gas_cost_budget"] / $currentBudgetActualData["total_natural_gas_budget"], $value_decimal) : 0;

    $water_tariff_budget = ($currentBudgetActualData["water_total_consumption_budget"] != 0) ? round($currentBudgetActualData["water_total_consumption_cost_budget"] / $currentBudgetActualData["water_total_consumption_budget"], $value_decimal) : 0;

    $district_cooling_tariff_budget = ($currentBudgetActualData["district_cooling_budget"] != 0) ?  round($currentBudgetActualData["district_cooling_cost_budget"] / $currentBudgetActualData["district_cooling_budget"], $value_decimal) : 0;

    $district_heating_tariff_budget = ($currentBudgetActualData["district_heating_budget"] != 0) ? round($currentBudgetActualData["district_heating_cost_budget"] / $currentBudgetActualData["district_heating_budget"], $value_decimal) : 0;



    $electricity_tariff_actual = ($currentBudgetActualData["total_electricity_kwh_actual"] != 0) ? round($currentBudgetActualData["total_electricity_cost_actual"] / $currentBudgetActualData["total_electricity_kwh_actual"], $value_decimal) : 0;

    $fuel_oil_tariff_actual = ($currentBudgetActualData["total_fuel_oil_actual"] != 0) ? round($currentBudgetActualData["total_fuel_oil_cost_actual"] / $currentBudgetActualData["total_fuel_oil_actual"], $value_decimal) : 0;

    $lpg_tariff_actual = ($currentBudgetActualData["total_lpg_actual"] != 0) ? round($currentBudgetActualData["total_lpg_cost_actual"] / $currentBudgetActualData["total_lpg_actual"], $value_decimal) : 0;

    $natural_gas_tariff_actual = ($currentBudgetActualData["total_natural_gas_actual"] != 0) ? round($currentBudgetActualData["total_natural_gas_cost_actual"] / $currentBudgetActualData["total_natural_gas_actual"], $value_decimal) : 0;

    $water_tariff_actual = ($currentBudgetActualData["water_total_consumption_actual"] != 0) ? round($currentBudgetActualData["water_total_consumption_cost_actual"] / $currentBudgetActualData["water_total_consumption_actual"], $value_decimal) : 0;

    $district_cooling_tariff_actual = ($currentBudgetActualData["district_cooling_actual"] != 0) ?  round($currentBudgetActualData["district_cooling_cost_actual"] / $currentBudgetActualData["district_cooling_actual"], $value_decimal) : 0;

    $district_heating_tariff_actual = ($currentBudgetActualData["district_heating_actual"] != 0) ? round($currentBudgetActualData["district_heating_cost_actual"] / $currentBudgetActualData["district_heating_actual"], $value_decimal) : 0;



    $electricity_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_electricity_kwh_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $fuel_oil_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_fuel_oil_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $lpg_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_lpg_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $natural_gas_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_natural_gas_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $water_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["water_total_consumption_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $district_cooling_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["district_cooling_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $district_heating_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["district_heating_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;



    $electricity_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_electricity_kwh_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $fuel_oil_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_fuel_oil_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $lpg_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_lpg_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $natural_gas_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_natural_gas_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $water_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["water_total_consumption_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $district_cooling_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["district_cooling_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $district_heating_per_room_night_budget = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["district_heating_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;



    $electricity_tariff_variation = ($electricity_tariff_budget != 0) ? round((($electricity_tariff_actual - $electricity_tariff_budget) * 100) / $electricity_tariff_budget, $percentage_decimal) : 0;

    $fuel_oil_tariff_variation = ($fuel_oil_tariff_budget != 0) ? round((($fuel_oil_tariff_actual - $fuel_oil_tariff_budget) * 100) / $fuel_oil_tariff_budget, $percentage_decimal) : 0;

    $lpg_tariff_variation =  ($lpg_tariff_budget != 0) ? round((($lpg_tariff_actual - $lpg_tariff_budget) * 100) / $lpg_tariff_budget, $percentage_decimal) : 0;

    $natural_gas_tariff_variation = ($natural_gas_tariff_budget != 0) ? round((($natural_gas_tariff_actual - $natural_gas_tariff_budget) * 100) / $natural_gas_tariff_budget, $percentage_decimal) : 0;

    $water_tariff_variation = ($water_tariff_budget != 0) ? round((($water_tariff_actual - $water_tariff_budget) * 100) / $water_tariff_budget, $percentage_decimal) : 0;

    $district_cooling_tariff_variation = ($district_cooling_tariff_budget != 0) ? round((($district_cooling_tariff_actual - $district_cooling_tariff_budget) * 100) / $district_cooling_tariff_budget, $percentage_decimal) : 0;

    $district_heating_tariff_variation = ($district_heating_tariff_budget) ? round((($district_heating_tariff_actual - $district_heating_tariff_budget) * 100) / $district_heating_tariff_budget, $percentage_decimal) : 0;
    ...
    $electricity_per_room_night_variation = ($electricity_per_room_night_budget != 0) ? round(($electricity_per_room_night_actual - $electricity_per_room_night_budget) * 100 / $electricity_per_room_night_budget, $percentage_decimal) : 0;

    $fuel_oil_per_room_night_variation = ($fuel_oil_per_room_night_budget != 0) ? round(($fuel_oil_per_room_night_actual - $fuel_oil_per_room_night_budget) * 100 / $fuel_oil_per_room_night_budget, $percentage_decimal) : 0;

    $lpg_per_room_night_variation = ($lpg_per_room_night_budget != 0) ? round(($lpg_per_room_night_actual - $lpg_per_room_night_budget) * 100 / $lpg_per_room_night_budget, $percentage_decimal) : 0;

    $natural_gas_per_room_night_variation = ($natural_gas_per_room_night_budget != 0) ? round(($natural_gas_per_room_night_actual - $natural_gas_per_room_night_budget) * 100 / $natural_gas_per_room_night_budget, $percentage_decimal) : 0;

    $water_per_room_night_variation = ($water_per_room_night_budget != 0) ? round(($water_per_room_night_actual - $water_per_room_night_budget) * 100 / $water_per_room_night_budget, $percentage_decimal) : 0;

    $district_cooling_per_room_night_variation = ($district_cooling_per_room_night_budget != 0) ? round(($district_cooling_per_room_night_actual - $district_cooling_per_room_night_budget) * 100 / $district_cooling_per_room_night_budget, $percentage_decimal) : 0;

    $district_heating_per_room_night_variation = ($district_heating_per_room_night_budget != 0) ?  round(($district_heating_per_room_night_actual - $district_heating_per_room_night_budget) * 100 / $district_heating_per_room_night_budget, $percentage_decimal) : 0;
    ...
    $total_cost_actual_per_room_night = ($currentBudgetActualData["total_room_night"] != 0) ? round($total_cost_actual / $currentBudgetActualData["total_room_night"], $value_decimal) : 0;
...
echo '<div style="padding-top:10px !important;"></div>';
echo '<br><br><div style="border:2px solid  #f69546;padding:6px;">';
echo '<br><br>';
