						...
						<tr>
								...
								<table width="100%" cellpadding="0" cellspacing="0">
									<tbody>
										<tr>
											...
											<td width="30%"><?php echo number_format($total_sum_data_total_room_night_budget); ?></td>
										</tr>
										<tr>
											<td width="35%"><?php echo number_format($total_sum_data_guest_night); ?></td>
											<td width="35%"><?php echo number_format($total_sum_pre_data_guest_night); ?></td>
											<td width="30%"><?php echo number_format($total_sum_data_guest_night_budget); ?></td>
										</tr>
										<tr>
							...
							<td width="30%">
								<table width="100%" cellpadding="0" cellspacing="0">
									<tbody>
										...
										<tr>
											<?php $guest_night_difference = ($total_sum_data_guest_night - $total_sum_pre_data_guest_night); ?>
											<td width="35%" align="center" style="<?php echo $guest_night_difference < 0 ? $positive_number_style : ''; ?>"><?php echo number_format($guest_night_difference); ?></td>
											<td width="35%" align="center" style="<?php echo $guest_night_difference < 0 ? $positive_number_style : ''; ?>"><?php echo $total_sum_data_guest_night_variation; ?>%</td>
											<td width="30%" align="center"></td>
										</tr>
										<tr>
							...
							<td width="20%">
								<table width="100%" cellpadding="0" cellspacing="0">
									<tbody>
										<?php
										$room_night_act_bud_diff = $total_sum_data_room_night - $total_sum_data_total_room_night_budget;
										$room_night_budget_variation = ($total_sum_data_total_room_night_budget != 0) ? round(($room_night_act_bud_diff * 100) / $total_sum_data_total_room_night_budget, $percentage_decimal) : 0;
										?>
										<tr style="<?php echo $room_night_act_bud_diff < 0 ? $positive_number_style : ''; ?>">
											<td width="50%" style="text-align: center;"><?php echo number_format($room_night_act_bud_diff); ?></td>
											<td width="50%" style="text-align: center;"><?php echo number_format($room_night_budget_variation, $percentage_decimal) . "%"; ?></td>
										</tr>
										<?php
										$guest_night_act_bud_diff = $total_sum_data_guest_night - $total_sum_data_guest_night_budget;
										$guest_night_budget_variation = ($total_sum_data_guest_night_budget != 0) ? round(($guest_night_act_bud_diff * 100) / $total_sum_data_guest_night_budget, $percentage_decimal) : 0;
										?>
										<tr style="<?php echo $guest_night_act_bud_diff < 0 ? $positive_number_style : ''; ?>">
											<td style="text-align: center;"><?php echo number_format($guest_night_act_bud_diff); ?></td>
											<td style="text-align: center;"><?php echo number_format($guest_night_budget_variation, $percentage_decimal) . "%"; ?></td>
										</tr>
										<tr>
											<td></td>
											<td></td>
									...
									<table width="100%" cellpadding="0" cellspacing="0">
										<tbody>
											...
											<tr style="<?php echo $lpg_act_bud_diff > 0 ? $positive_number_style : ''; ?>">
												...
												<td width="50%" style="text-align: center;"><?php echo number_format(($currentBudgetActualData["total_lpg_budget"] != 0) ? $lpg_act_bud_diff * 100 / $currentBudgetActualData["total_lpg_budget"] : 0, $percentage_decimal) . "%"; ?></td>
											</tr>
									...
									<table width="100%" cellpadding="0" cellspacing="0">
										<tbody>
											<?php $natural_gas_act_bud_diff = $currentBudgetActualData["total_natural_gas_actual"] - $currentBudgetActualData["total_natural_gas_budget"];
													$diff = ($currentBudgetActualData["total_natural_gas_budget"] != 0) ? $natural_gas_act_bud_diff * 100 / $currentBudgetActualData["total_natural_gas_budget"] : 0;
									...
									<table width="100%" cellpadding="0" cellspacing="0">
										<tbody>
											...
											<tr style="<?php echo $district_cooling_act_bud_diff > 0 ? $positive_number_style : ''; ?>">
												...
												<td width="50%" style="text-align: center;"><?php echo number_format(($currentBudgetActualData["district_cooling_budget"] != 0) ? ($currentBudgetActualData["district_cooling_actual"] - $currentBudgetActualData["district_cooling_budget"]) * 100 / $currentBudgetActualData["district_cooling_budget"] : 0, $percentage_decimal) . "%"; ?></td>
											</tr>
