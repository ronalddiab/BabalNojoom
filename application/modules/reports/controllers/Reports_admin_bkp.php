...
class Reports_admin extends Base_Admin_Controller {
    ...
    public function __construct() {
        ...
        /* $result_month_id = $this->reports_model->getMaxCurrentMonth();
          if(!empty($result_month_id) && $result_month_id<date('m')){
          define('CURRENT_YEAR_MAX_MONTH_ID', $result_month_id);
          }else{
          define('CURRENT_YEAR_MAX_MONTH_ID', date('m') - 1);
          } */
    }
    ...
    private function access_rules() {
        return array(
            array(
                'actions' => array('index', 'advance', 'sites', 'roomnight', 'carbon', 'budget', 'management', 'daily', 'export', 'generate_report_pdf', 'generate_report_excel', 'report_calculations', 'report_layout_excel', 'daily_metering', 'annual_excel_report'),
                'users' => array('@'),
            ), array(
    ...
    public function index($cview = 'index') {
        ...
        if($this->input->post('yearly_report_year')){
            $startdate = '1/' . $this->input->post('yearly_report_year', date('Y'));
            $enddate = '12/' . $this->input->post('yearly_report_year', date('Y'));   
        }
        ...
        $utility_west_chart_results = $this->reports_model->utilityWasteChart($filters_comparision_chart);
        $waste_monthly_pie_chart_results = $this->reports_model->wasteMonthlyPieChart($filters_comparision_chart);
        ...
        if (!empty($utility_west_chart_results)) {
            ...
            // pre($utility_west_chart_results);
            foreach ($utility_west_chart_results as $key => $val) {
                $totalGeneralWaste += ($val['operation_general_waste'] != '') ? $val['operation_general_waste'] : 0;
                $totalPaperWaste += ($val['operation_paper_waste'] != '') ? $val['operation_paper_waste'] : 0;
                $totalFoodWaste += ($val['operation_food_waste'] != '') ? $val['operation_food_waste'] : 0;
                $totalCardboardWaste += ($val['operation_cardboard_waste'] != '') ? $val['operation_cardboard_waste'] : 0;
                $totalPlasticWaste += ($val['operation_plastic_waste'] != '') ? $val['operation_plastic_waste'] : 0;
                $totalGlassWaste += ($val['operation_glass_waste'] != '') ? $val['operation_glass_waste'] : 0;
                $totalRecycledWaste += ($val['operation_recycled_waste'] != '') ? $val['operation_recycled_waste'] : 0;
        ...
        $utility_waste_chart_results_pre = $this->reports_model->utilityWasteBarChart($filters_comparision_chart_pre);
        ...
        if (!empty($utility_cost_chart_results_pre)) {
            ...
            foreach ($utility_cost_chart_results_pre as $key => $value) {
                ...
                // pre($data['utility_cost_chart_pre']);
        ...
        $waste_anual_pie = $this->reports_model->wasteBasedReportForCurrentYear($filters_pre);
        ...
        $waste_pie_report_results = $this->reports_model->wasteReportCurrentYear($filters);
        ...
        $waste_pie_report_landfill = $this->reports_model->wasteReportCurrentYear($filters);
    ...
    public function getMonthlyReportChart() {
        ...
        $waste_monthly_chart_results = $this->reports_model->wasteMonthlyChart($filters_comparision_chart);
        ...
        $data['kwh_pie_chart_title'] = 'Energy Consumption (MJ) - ' . $monthName . ' ' . $pie_filters['report_year_piechart'];
    ...
    public function carbon_footprint() {
        ...
        if ($view_type == 'excel') {
            ...
            if ($totalElectricity > 0) {
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_electricity_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;

                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_electricity_kgco2_year"), intval($filters["end_year"])));
                $alphaInc++;
            }

            if ($totalFuel > 0) {
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_fuel_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;

                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_fuel_kgco2_year"), $filters["end_year"]));
                $alphaInc++;
            }

            if ($totalLpg > 0) {
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_lpg_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;

                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_lpg_kgco2_year"), $filters["end_year"]));
                $alphaInc++;
            ...
            if ($totalNaturalGas > 0) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_natural_gas_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_natural_gas_kgco2_year"), $filters["end_year"]));
                $alphaInc++;
            }
            ...
            if ($totalHeatingDistrict > 0) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_heating_district_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_heating_district_kgco2_year"), $filters["end_year"]));
                $alphaInc++;
            }

            if ($totalCoolingDistrict > 0) {

                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_cooling_district_kgco2_year"), $filters["end_year"] - 1));
                $alphaInc++;
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue("{$fullAlphaArray[$alphaInc]}1", sprintf(lang("cf_excel_cooling_district_kgco2_year"), $filters["end_year"]));
                $alphaInc++;
            }
            ...
            ob_end_clean();
            header('Content-Type: application/vnd.ms-excel');
            header('Content-Disposition: attachment;filename="Carbon Footprint.xls"');
            header('Cache-Control: max-age=0');
            // If you're serving to IE 9, then the following may be needed
            header('Cache-Control: max-age=1');
    ...
    public function advance() {
        ...
        if ($base_type == 'unit') {
            ...
            if (!empty($results)) {
                foreach ($results as $key => $value) {
                    $results[$key]['cooling_district'] = $value['cooling_district'] + $value['district_cooling_fixed_cost'];
                    $results[$key]['heating_district'] = $value['heating_district'] + $value['district_heating_fixed_cost'];
                }
            }
        }
        ...
        if ($view_type == 'excel') {
            ...
            if (in_array($utilitychanger, $YTDdefaultreports) || $time_type == 'advance_select_avg_ytd') {
                ...
                switch ($report_tmpl) {
                    case 'admin_advance_budget_forcasted':
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Month')
                            ->setCellValue('B1', sprintf(lang("excel_{$utility_type}_{$base_type}_year"), $filters["end_year"]))
                            ->setCellValue('C1', sprintf(lang("excel_{$utility_type}_{$base_type}_year"), $filters["end_year"] - 1))
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Month')
                    ->setCellValue('B1', lang("excel_{$utility_type}_{$formtype}_{$base_type}"))
            ...
            if (!empty($sites)) {
                ...
                switch ($report_type) {
                    ...
                    case 'utilities_cost_consumption_site_efficiency_benchmark':
                        ...
                        $x_axis_title = BASE_CURRENCY_SYMBOL . '/m2';
                        $filters['base_type'] = 'cost';
                        break;
    ...
    public function daily() {
        ...
        foreach ($dropdownArray as $option) {
            ...
            $utilityTitlesArray[$option['utility_id']][$option['id']] = [
                'id' => $option['id'],
                'title' => $option['utility_title'],
            ];
            $utilityTitles[$option['id']] = [
                'name' => $option['utility_title'],
...
//            pre($data);
    ...
    public function prepare_budget() {
        ...
        for ($i = 0; $i < $total_years; $i++) {
            ...
            /*
              f ($data['currency'] == "base") {
              $utility_cost_chart_results = $this->reports_forex_model->utilityCostBarChart($filters_comparision_chart);
              } else {
              $utility_cost_chart_results = $this->reports_model->utilityCostBarChart($filters_comparision_chart);
              }

              // use this function for currency conversion
              $report_data_result = $this->reports_model->getFIlterUtilityMonthlyForex($filters);
        ...
        if (!empty($all_report_data)) {
            foreach ($all_report_data as $key => $value) {
                ...
                $report_data['data']['full_year']['roomnight'][$value['month_id']] = $report_data['data']['full_year']['roomnight'][$value['month_id']] + $value['total_room_night'];
                if ($value['month_id'] >= $current_month) {
                    $report_data['data']['ytd']['roomnight'][$value['month_id']] = $report_data['data']['ytd']['roomnight'][$value['month_id']] + $value['total_room_night'];
                }
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 1), 'Average CDD');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 2), 'Average HDD');
        $active_column++;
        ...
        foreach ($montharray as $month_id => $month_name) {
            ...
            $average_roomnight_total += round($average_roomnight_value, 0);
            $average_cdd_total += round($average_cdd_value, 0);
            $average_hdd_total += round($average_hdd_value, 0);

            $average_roomnight_value = round($average_roomnight_value);
            $average_cdd_value = round($average_cdd_value);
            $average_hdd_value = round($average_hdd_value);

            $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, $average_roomnight_value);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 1), $average_cdd_value);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 2), $average_hdd_value);

            $active_column++;
        }

        $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, $average_roomnight_total);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 1), $average_cdd_total);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . ($active_row + 2), $average_hdd_total);
        ...
        foreach ($data['utility_key_array'] as $utility) {
            ...
            $total = 0;
            foreach ($montharray as $month_id => $month_name) {
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, round($report_data[$year - 1][$month_id]['total_' . $utility['db_key']]));
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, round($total / 12));
            ...
            $total = 0;
            foreach ($montharray as $month_id => $month_name) {
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, round($report_data[$year][$month_id]['total_' . $utility['db_key']], 2));
            ...
            foreach ($montharray as $month_id => $month_name) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, round($avg_consumption));
            ...
            foreach ($montharray as $month_id => $month_name) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alphas[$active_column] . $active_row, round($avg_cost, 3));
        ...
        if (!empty($this->input->post())) {
            ...
            if ($postdata['submit'] == 'download_hidden') {
                ...
                foreach ($getUtilityData as $getUtilities) {
                    // pre($getUtilities);
                    $getUtilities = array_map('intval', $getUtilities);
                ...
                if ($result['show_waste_management']) {
                    $waste_monthly_reports = $this->load->view('admin_landing_pdf_waste_reports_monthly_hidden', $data, true);
                    $waste_monthly_piechart_reports = $this->load->view('admin_landing_pdf_waste_piechart_reports_monthly_hidden', $data, true);
                }
    ...
    public function report_calculations($data, $report_type) {
        ...
        if ($report_type == 'ytd') {
            ...
            $return['previous_title'] = 'Previous Year - ' . (date('Y') - 2);
    ...
    public function report_layout_excel($data, $flag = 'ytd') {
        ...
        if ($site_detail['show_utility_electricity']) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A' . $row1, 'Consumption (KWh)')
                ->setCellValue('A' . $row2, 'Average Tariff (' . currency_symbol($isLocal) . ' / KWh)')
        ...
        if ($site_detail['show_utility_fuel_oil']) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A' . $row1, 'Consumption (L)')
                ->setCellValue('A' . $row2, 'Average Tariff (' . currency_symbol($isLocal) . ' / L)')
                ->setCellValue('A' . $row3, 'Total Cost (' . currency_symbol($isLocal) . ')')
                ->setCellValue('A' . $row4, 'Consumption/Room Night');
            $objPHPExcel->setActiveSheetIndex(0)
        ...
        if ($site_detail['show_utility_lpg']) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A' . $row1, 'Consumption (Kg)')
                ->setCellValue('A' . $row2, 'Average Tariff (' . currency_symbol($isLocal) . ' / Kg)')
                ->setCellValue('A' . $row3, 'Total Cost (' . currency_symbol($isLocal) . ')')
                ->setCellValue('A' . $row4, 'Consumption/Room Night');
            $objPHPExcel->setActiveSheetIndex(0)
        ...
        if ($site_detail['show_utility_natural_gas']) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A' . $row1, 'Consumption (m3)')
                ->setCellValue('A' . $row2, 'Average Tariff (' . currency_symbol($isLocal) . ' / m3)')
                ->setCellValue('A' . $row3, 'Total Cost (' . currency_symbol($isLocal) . ')')
                ->setCellValue('A' . $row4, 'Consumption/Room Night');
            $objPHPExcel->setActiveSheetIndex(0)
    ...
    public function annual_excel_report($reportType = '',$selected_region, $selectedYear = '') {
        ...
        /* $electricity_mmbtu_rate      = '0.00341';
          $fuel_mmbtu_rate             = '0.040358';
          $lpg_mmbtu_rate              = '0.045276';
          $natural_gas_mmbtu_rate      = '0.0353';
          $heating_district_mmbtu_rate = '0.00341';
          $cooling_district_mmbtu_rate = '0.00341'; */
        ...
        // set report title
        $report_title = "Group Annual Energy Report Year : " . ($selectedYear);
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D3', 'Consumption (MJ)')
            ->setCellValue('E3', '%')
        ...
        foreach ($site_details as $site_detail) {
            ...
            foreach ($utility_cost_chart_results_pre as $key => $value) {
                ...
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['electricity'] = (!empty($value['total_electricity_kwh'])) ? $value['total_electricity_kwh'] : 0;
                ...
                // $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['fuel'] = (!empty($value['total_fuel_oil_cost'])) ? $value['total_fuel_oil_cost'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['fuel'] = (!empty($value['total_fuel_oil'])) ? $value['total_fuel_oil'] : 0;
                ...
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['lpg'] = (!empty($value['total_lpg_cost'])) ? $value['total_lpg_cost'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['lpg_consumption'] = (!empty($value['total_lpg'])) ? $value['total_lpg'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['natural_gas'] = (!empty($value['total_natural_gas'])) ? $value['total_natural_gas'] : 0;
                ...
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['heating_district'] = (!empty($value['district_heating_cost'])) ? $value['district_heating_cost'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['heating_district_consumption'] = (!empty($value['district_heating'])) ? $value['district_heating'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['cooling_district'] = (!empty($value['district_cooling_cost'])) ? $value['district_cooling_cost'] : 0;
                $data['utility_cost_chart_pre'][$site_id][$value['month_id']][$value['year_id']]['cooling_district_consumption'] = (!empty($value['district_cooling'])) ? $value['district_cooling'] : 0;
        ...
        if (isset($all_site_electricity) && (in_array("Electricity", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_electricity_share / count($site_details), 2),2))
        ...
        if (isset($all_site_fuel) && (in_array("Fuel", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_fuel_share / count($site_details), 2),2))
        ...
        if (isset($all_site_lpg) && (in_array("LPG", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_lpg_share / count($site_details), 2),2))
        ...
        if (isset($all_site_natural_gas) && (in_array("Natural Gas", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_natural_gas_share / count($site_details), 2),2))
        ...
        if (isset($all_site_district_heating) && (in_array("District Heating", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_district_heating_share / count($site_details), 2),2))
        ...
        if (isset($all_site_district_cooling) && (in_array("District Cooling", $utilities_array))) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $row, numb_format_without_currency(round($all_site_district_cooling_share / count($site_details), 2),2))
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $start_row, 'TOTAL GROUP');
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E' . $row, numb_format_without_currency(round($total_percentage_sites / count($site_details), 2),0))
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D'.$newSortedTableStartRow, 'CO2 (Tons CO2e) ');
        ...
        foreach ($sortedArray as $key => $value) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('C' . $startRow, numb_format_without_currency($value['Total Consumption'],0))
                    ->setCellValue('D' . $startRow, numb_format_without_currency($value['Total CO2'],0));
            $startRow++;
        }
        /* Create new Sorted list of MJ and CO2 */
        ...
        ob_end_clean();
        header('Content-Type: application/vnd.ms-excel');
        header('Content-Disposition: attachment;filename="Annual Group Energy Report.xls"');
        header('Cache-Control: max-age=0');
        // If you're serving to IE 9, then the following may be needed
        header('Cache-Control: max-age=1');
    ...
    public function get_all_sites_electricity_consumption($details = array(),$reportType = '', $selectedYear = ''){
        ...
        foreach ($site_details as $site_detail) {
            $site_id = $site_detail['id'];
            $site_name = $site_detail['site_location_name'];
            $filters_pre['report_year'] = ($selectedYear - 1);
            $filters_pre['max_month_id'] = 12;
            $filters_pre['site_id'] = $site_id;
            ...
            // pr($finalArray);
            // pr($kwh_pie_chart_pre);
            // pr($utility_kwh_total);
            // check share %    
            $electricity_share = (round(($electricity_value * 100) / $utility_kwh_total, 1) > 0) ? round(($electricity_value * 100) / $utility_kwh_total, 1) : 0;
            $fuel_share = (round(($fuel_value * 100) / $utility_kwh_total, 1) > 0) ? round(($fuel_value * 100) / $utility_kwh_total, 1) : 0;
            $lpg_share = (round(($lpg_value * 100) / $utility_kwh_total, 1) > 0) ? round(($lpg_value * 100) / $utility_kwh_total, 1) : 0;
            ...
            $total_sum_data_sum = ($total_sum_data_electricity + $total_sum_data_fuel + $total_sum_data_lpg + $total_sum_data_natural_gas + $total_sum_data_heating_district + $total_sum_data_cooling_district);
