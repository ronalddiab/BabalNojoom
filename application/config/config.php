...
$config['sess_cookie_name'] = 'hep_sessions';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = 'hep_sessions';
...
// Language Selector: 0 For Single & 1 For Multi language.
$config['multilang_option'] = '1';

// Section array used in whole website.
//$config['section_name'] = array('' => 'front', 'admin' => 'admin');
$config['section_name'] = array('' => 'admin', 'admin' => 'admin');

//For action to do colors
$config['action_to_do_colors'] = array('#FF0000' => 'Red', '#FF8000' => 'Orange', '#FFFF00' => 'Yellow', '#008000' =>  'Green',  '#1E90FF' =>  'Blue');

$config['YTD_month_count'] = date('m')-1;
if (date('m') == 1) {
